...
var localIcons = [ iconAddress + "/icons/meat.png",
		...
		iconAddress + "/icons/salad_color.png",
		iconAddress + "/icons/water-bottle-color.png",
		iconAddress + "/icons/coffe_color.png",
		...
		iconAddress + "/icons/candy-color.png" ,
		iconAddress + "/icons/smoothie-color.png" ,
		iconAddress + "/icons/spaguetti-color.png" ,
		iconAddress + "/icons/hamburger_color.png" ,
		iconAddress + "/icons/donut-color.png" ,
		iconAddress + "/icons/salmon-color.png",
		
		iconAddress + "/icons/cappuccino-live.png" ,
		iconAddress + "/icons/crosaint-live.png" ,
		iconAddress + "/icons/hamburger-live.png" ,
		iconAddress + "/icons/pasta-live.png" ,
		iconAddress + "/icons/salad-live.png" ,
		iconAddress + "/icons/salmon-live.png" ,
		iconAddress + "/icons/cold-live.png" ,
		iconAddress + "/icons/smoothie-live.png" ,
		iconAddress + "/icons/snacks-live.png" 
	];
...
function initIcons() {
	...
	$.each(localIcons, function(index, element) {
		...
		$('.image-picker').append(
				"<option data-img-src= " + element + " value=" + index
						+ "> </option>");
